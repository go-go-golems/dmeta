...
RelatedFiles:
    - Path: dmeta/sources/dmeta-ir/01-core-model.yaml
      Note: Primary source IR for archetypes, capabilities, presentations, actions, and domain examples
...
## Source IR: `01-core-model.yaml`

The core generator consumes mostly `01-core-model.yaml`. That file contains these top-level sections:
...
```ts
// Code generated by dmeta generate-core from sources/dmeta-ir/01-core-model.yaml. DO NOT EDIT.
```
