...
func validateArtifactIdentity(pkg *Package) []Finding {
	...
	checks := []struct {
		...
		{"web_meta_design_system", "artifact_type", pkg.Widgets.ArtifactType, "dmeta_meta_design_system", pkg.Widgets.SchemaVersion},
	}
