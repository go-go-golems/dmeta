...
| --- | --- | --- | --- |
| `01-design-system-factory-vision-and-scope.md` | **Keep** | Explains the factory motivation, dense operational UI goal, presentation-based UI, and generation/promotion discipline. | Foundation doc; current operational details live in docs 04-06 and playbooks. |
...
| `03-dense-operational-ui-graphic-design-and-ux-archetype.md` | **Keep** | Describes the shared dense operational visual archetype. | Foundation doc; target-specific consumption is now documented in `06-dmeta-design-language-and-tooling-spec.md`. |
| `04-concrete-dmeta-system-spec.md` | **Updated** | Now describes the current layered compiler architecture with Semantic IR, Interaction IR, Web MetaDesignSystem, PBUI MetaDesignSystem, and target apps. | Keep current. |
| `05-dmeta-core-model-and-widget-ir-spec.md` | **Updated** | Rewritten as the shared Semantic and Interaction IR spec. Widget-specific guidance moved out of the shared core-model doc. | Keep current. |
| `06-dmeta-design-language-and-tooling-spec.md` | **Updated** | Rewritten as the MetaDesignSystem targets and tooling spec covering Web React and PBUI/CLIM React. | Keep current. |
...
## Completed design-doc cleanup sequence
...
### Step 2: Rewrite the system spec — completed
...
### Step 3: Split widget/design/tooling specs — completed
...
The split is now represented by:

```text
design-docs/05-dmeta-core-model-and-widget-ir-spec.md      # shared Semantic and Interaction IR spec
design-docs/06-dmeta-design-language-and-tooling-spec.md  # Web/PBUI MetaDesignSystem target and tooling spec
```
...
design-docs/02-semantic-archetype-and-capability-model.md
design-docs/03-dense-operational-ui-graphic-design-and-ux-archetype.md
design-docs/04-concrete-dmeta-system-spec.md              # current DMETA compiler system spec
design-docs/05-dmeta-core-model-and-widget-ir-spec.md     # shared Semantic and Interaction IR spec
design-docs/06-dmeta-design-language-and-tooling-spec.md  # MetaDesignSystem targets and tooling spec
...
The playbooks and active design docs now describe the current system: shared Semantic/Interaction IR, Web React target line, PBUI/CLIM React target line, retained static prototypes, and archived legacy generated-widget review material.
