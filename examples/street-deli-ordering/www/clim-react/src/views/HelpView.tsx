...
export function HelpView() {
  return (
    <section className="story-card" aria-label="HELP view">
      <div className="cmd-bar"><span className="prompt">HELP&gt;</span><span className="cmd-text">LIST PRESENTATIONS</span></div>
