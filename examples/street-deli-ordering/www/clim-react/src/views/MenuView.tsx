...
export function MenuView() {
  return (
    <section className="story-card" aria-label="MENU view">
      <div className="cmd-bar"><span className="prompt">MENU&gt;</span><span className="cmd-text">LIST PRESENTATIONS</span></div>
