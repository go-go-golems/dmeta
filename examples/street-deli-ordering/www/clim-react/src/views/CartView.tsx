...
export function CartView() {
  return (
    <section className="story-card" aria-label="CART view">
      <div className="cmd-bar"><span className="prompt">CART&gt;</span><span className="cmd-text">LIST PRESENTATIONS</span></div>
