...
export function TrackerView() {
  return (
    <section className="story-card" aria-label="TRACKER view">
      <div className="cmd-bar"><span className="prompt">TRACKER&gt;</span><span className="cmd-text">LIST PRESENTATIONS</span></div>
