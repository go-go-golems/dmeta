...
export const dmetaGeneratedMetadata = {
  ...
  "artifact": {
    "path": "examples/street-deli-ordering/www/clim-react/src/components/command/ClimCommandBar.tsx",
    "kind": "command_bar_component",
    "language": "tsx",
    "symbol": "ClimCommandBar",
    "promotable": true
  },
  "pipeline": {
  ...
  "pbui": {
    "bindingComponent": "ClimCommandBar",
    "styleClasses": [
