...
export interface ClimCommandBarProps {
...
export function ClimCommandBar({ presentation = menuItemPresentation, action = removeIngredientAction, steps = trackerSteps, selected = false, selectable = false, disabled = false, title = 'ClimCommandBar' }: ClimCommandBarProps) {
