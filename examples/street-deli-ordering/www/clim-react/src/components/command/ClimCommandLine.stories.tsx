...
export const dmetaGeneratedMetadata = {
  ...
  "artifact": {
    "path": "examples/street-deli-ordering/www/clim-react/src/components/command/ClimCommandLine.stories.tsx",
    "kind": "command_line_story",
    "language": "tsx",
    "symbol": "ClimCommandLineStories",
    "promotable": true
  },
  "pipeline": {
  ...
  "pbui": {
    "bindingComponent": "ClimCommandLine",
    "styleClasses": [
