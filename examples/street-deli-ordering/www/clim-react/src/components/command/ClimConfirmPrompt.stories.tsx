...
export const dmetaGeneratedMetadata = {
  ...
  "artifact": {
    "path": "examples/street-deli-ordering/www/clim-react/src/components/command/ClimConfirmPrompt.stories.tsx",
    "kind": "confirm_prompt_story",
    "language": "tsx",
    "symbol": "ClimConfirmPromptStories",
    "promotable": true
  },
  "pipeline": {
