...
export const dmetaGeneratedMetadata = {
  ...
  "artifact": {
    "path": "examples/street-deli-ordering/www/clim-react/src/components/command/ClimContextMenu.stories.tsx",
    "kind": "context_menu_story",
    "language": "tsx",
    "symbol": "ClimContextMenuStories",
    "promotable": true
  },
  "pipeline": {
