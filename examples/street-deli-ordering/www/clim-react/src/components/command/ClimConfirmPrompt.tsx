...
export const dmetaGeneratedMetadata = {
  ...
  "artifact": {
    "path": "examples/street-deli-ordering/www/clim-react/src/components/command/ClimConfirmPrompt.tsx",
    "kind": "confirm_prompt_component",
    "language": "tsx",
    "symbol": "ClimConfirmPrompt",
    "promotable": true
  },
  "pipeline": {
  ...
  "pbui": {
    "bindingComponent": "ClimConfirmPrompt",
    "styleClasses": [
