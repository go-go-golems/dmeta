...
export interface ClimConfirmPromptProps {
...
export function ClimConfirmPrompt({ presentation = menuItemPresentation, action = removeIngredientAction, steps = trackerSteps, selected = false, selectable = false, disabled = false, title = 'ClimConfirmPrompt' }: ClimConfirmPromptProps) {
