...
export const dmetaGeneratedMetadata = {
  ...
  "artifact": {
    "path": "examples/street-deli-ordering/www/clim-react/src/components/command/ClimContextMenu.tsx",
    "kind": "context_menu_component",
    "language": "tsx",
    "symbol": "ClimContextMenu",
    "promotable": true
  },
  "pipeline": {
  ...
  "pbui": {
    "bindingComponent": "ClimContextMenu",
    "styleClasses": [
