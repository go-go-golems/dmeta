...
export interface CompositionPresentationBlockProps {
...
export function CompositionPresentationBlock({ presentation = menuItemPresentation, action = removeIngredientAction, steps = trackerSteps, selected = false, selectable = false, disabled = false, title = 'CompositionPresentationBlock' }: CompositionPresentationBlockProps) {
