...
export interface PresentationRefLineProps {
...
export function PresentationRefLine({ presentation = menuItemPresentation, action = removeIngredientAction, steps = trackerSteps, selected = false, selectable = false, disabled = false, title = 'PresentationRefLine' }: PresentationRefLineProps) {
