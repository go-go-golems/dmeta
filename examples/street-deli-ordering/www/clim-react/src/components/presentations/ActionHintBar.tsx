...
export function ActionHintBar({ presentation = menuItemPresentation, action = removeIngredientAction, steps = trackerSteps, selected = false, selectable = false, disabled = false, title = 'ActionHintBar' }: ActionHintBarProps) {
