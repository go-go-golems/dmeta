...
import { ActionPresentationInline } from './ActionPresentationInline';

const meta = {
  title: 'CLIM/Presentations/ActionPresentationInline',
  component: ActionPresentationInline,
  decorators: [(Story) => <ClimStoryShell modeLabel="MENU"><Story /></ClimStoryShell>],
} satisfies Meta<typeof ActionPresentationInline>;
