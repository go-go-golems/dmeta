...
export const dmetaGeneratedMetadata = {
  ...
  "artifact": {
    "path": "examples/street-deli-ordering/www/clim-react/src/generated/pbuiRegistries.ts",
    "kind": "generated_registry_copy",
    "language": "ts",
    "symbol": "pbuiRegistries",
    "promotable": true
  },
  "pipeline": {
...
export const presentationTypeIds = ["pbui.action_chooser", "pbui.lifecycle_status", "pbui.composition_presentation", "pbui.action_presentation", "pbui.presentation_ref", "pbui.inspector_panel"] as const;
