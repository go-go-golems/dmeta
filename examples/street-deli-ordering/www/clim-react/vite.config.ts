...
export const dmetaGeneratedMetadata = {
  ...
  "artifact": {
    "path": "examples/street-deli-ordering/www/clim-react/vite.config.ts",
    "kind": "vite_config",
    "language": "ts",
    "symbol": "viteConfig",
    "promotable": false
  ...
  "promotion": {
    ...
    "status": "regenerate",
    "instructions": [
      "Do not edit this file by hand; regenerate it from DMETA sources."
    ]
  }
} as const;

/**
 * DMETA generated artifact: regenerate-only
 *
 * Instructions:
